  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed bottom-8 right-8 z-50">
        ...
        >
          <span className="absolute -left-32 bg-dark-lighter border border-white/10 px-4 py-2 text-[10px] font-black uppercase tracking-widest text-white opacity-0 group-hover:opacity-100 transition-all pointer-events-none whitespace-nowrap">Próximamente WhatsApp</span>
